            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
               {/* {!isLogin && (
                  <div>
                     ...
                     <input
                        {...register('email')}
                        className={`w-full p-4 bg-black/40 rounded-xl border ${errors.email ? 'border-red-500' : 'border-white/10'} focus:border-magic-purple outline-none text-white placeholder-gray-600`}
