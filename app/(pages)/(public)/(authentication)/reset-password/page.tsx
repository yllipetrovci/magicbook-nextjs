...
const ResetPassword = () => {
   ...
   const { config, hasUpSellBook, hasUpSellVideo, hasUpSellDaily, mainPaymentIsDone, resetAll } = useStory();
      ...
      try {
         ...
         const res = await fetch("/api/firebase/create-account", {
            ...
            body: JSON.stringify({
               ...
               config: { ...configWithoutOriginals, hasUpSellBook, hasUpSellVideo, hasUpSellDaily, mainPaymentIsDone }
            }),
      });
