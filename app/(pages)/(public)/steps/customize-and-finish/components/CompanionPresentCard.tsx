...
const CompanionButton: React.FC<CompanionButtonProps> = ({ companion, onAdd }) => {
    return (
        <button
            ...
            className="flex flex-col justify-center  items-center gap-1 p-2 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 hover:scale-105 transition-all"
        >
